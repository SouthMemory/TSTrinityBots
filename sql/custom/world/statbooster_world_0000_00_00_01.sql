...
INSERT INTO `command`(`name`, `help`) VALUES ('sb', 'Syntax: .sb - type .sb to list subcommands.');

DELETE FROM `command` WHERE name='sb additem';
INSERT INTO `command`(`name`, `help`) VALUES ('sb additem', 'Syntax: .sb additem <itemid> <count> - tries to add an enchanted item to targeted player.');
...
INSERT INTO `statbooster_enchant_template` (`Id`, `iLvlMin`, `iLvlMax`, `RoleMask`, `ClassMask`, `SubClassMask`, `Description`, `Note`) VALUES
	...
	(75, 1, 30, 7, 0, 0, '+2 Agility', 'TANK/PHYS/HYBRID - ALL - ALL'),
	(69, 1, 30, 3, 0, 0, '+2 Strength', 'TANK/PHYS - ALL - ALL'),
	(80, 1, 30, 12, 0, 0, '+2 Intellect', 'HYBRID/SPELL - ALL - ALL'),
	(72, 1, 30, 0, 0, 0, '+2 Stamina', 'ALL - ALL - ALL'),
	(83, 1, 30, 8, 0, 0, '+2 Spirit', 'SPELL - ALL - ALL'),
	(207, 1, 30, 8, 0, 0, '+2 Spell Power', 'SPELL - ALL - ALL'),
	(76, 1, 40, 7, 0, 0, '+3 Agility', 'TANK/PHYS/HYBRID - ALL - ALL'),
	(81, 1, 40, 12, 0, 0, '+3 Intellect', 'HYBRID/SPELL - ALL - ALL'),
	(73, 1, 40, 0, 0, 0, '+3 Stamina', 'ALL - ALL - ALL'),
	(64, 1, 40, 8, 0, 0, '+3 Spirit', 'SPELL - ALL - ALL'),
	(70, 1, 40, 3, 0, 0, '+3 Strength', 'TANK/PHYS - ALL - ALL'),
	(2910, 1, 40, 8, 0, 0, '+3 Spell Power', 'SPELL - ALL - ALL'),
	(90, 1, 50, 7, 0, 0, '+4 Agility', 'TANK/PHYS/HYRBRID - ALL - ALL'),
	(94, 1, 50, 12, 0, 0, '+4 Intellect', 'HYBRID/SPELL - ALL - ALL'),
	(102, 1, 50, 0, 0, 0, '+4 Stamina', 'ALL - ALL - ALL'),
	(99, 1, 50, 8, 0, 0, '+4 Spirit', 'SPELL - ALL - ALL'),
	(106, 1, 50, 3, 0, 0, '+4 Strength', 'TANK/PHYS - ALL - ALL'),
	(208, 1, 50, 8, 0, 0, '+4 Spell Power', 'SPELL - ALL - ALL'),
