...
public:
    ...
    public:
        ...
        EnchantDefinition* GetByPlayerLevel(uint32 roleMask, uint32 classMask, uint32 subClassMask, uint32 itemTypeMask, uint32 playerLevel);
        bool Load();
        void Clear();
